...
def main():
    ...
    Your work could help in the search for a cure for Parkinson’s disease, which would alleviate the substantial suffering and medical care costs of patients with this disease.
        ...
        with c1:
            st.info('**Data Analyst: [@Kawng](https://techtalkwithkwanghyun.tistory.com/)**', icon="💡")
        with c2:
            st.info('**GitHub: [@MST](https://github.com/Kwanghyun97/Parkinson_PJ/blob/main/README.md)**', icon="💻")
        with c3:
            st.info(
